...
Input Format:
    ...
    The first and only line of each test case contains two space-separated integers A,B and XX
    — the parameters mentioned in the statement.

Output Format:
For each test case, output YES if you can make A and B equal after applying the operation any number of times 
(possibly zero). Otherwise, output NO.
...
Test Case 1: The initial values of (A,B) is (5,7). We can perform the following operation: (5,7)→A=A+X,B=B−X​(6,6).
