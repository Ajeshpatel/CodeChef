...
There are NN spooky days left until Halloween.
...
Explanation:
Test case 1: The first day is Monday, and Dracula has only one day. So, no Tuesdays are encountered,
and the answer is 0.

Test case 2: The first day is Monday, so the second and ninth days are Tuesdays.
Dracula can eat his favorite meal twice.

Test case 3: Once again, the second and ninth days are Tuesday, so in 15 days, Dracula still gets to eat his
favorite meal only twice.

Test case 4: After the ninth day, the 16-th day is also a Tuesday. So, this time Dracula gets to eat his
favorite meal three times - on days 2,9,16.
"""
# --------------------SOLUTION-----------------
# cook your dish here
t = int(input())
