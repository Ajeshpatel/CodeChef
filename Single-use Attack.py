...
Input Format:
    ...
    The first and only line of each test case will contain three space-separated integers H,X,Y — the parameters 
...
Explanation:
Test case 1: Chef can attack the boss 4 times normally. This results in 25+25+25+25=100 damage, which is enough 
to defeat the boss.

Test case 2: Chef can attack the boss 2 times normally, then use the special attack. This results in 
...
Test case 3: Chef can proceed as follows:
    ...
    Then, use 4 normal attacks to defeat the boss, since each one does 1 damage.

This takes a total of 44+1=45 attacks.

Test case 4: Chef can use the special attack to immediately bring the health of the boss to zero,
...
for _ in range(t):
    ...
    after_specil_attack = (H-Y)
    
    if(after_specil_attack % X == 0):
        result = (after_specil_attack//X) + 1
        print(result)
    else:
        result = (after_specil_attack//X) + 2
        print(result)