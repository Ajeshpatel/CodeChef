...
Test Case 2: 22 cards are facing up and 22 cards are facing down. Therefore we can flip the 22 cards 
which are initially facing down.

Test Case 3: All the cards are already facing up. Therefore we do not need to perform any operations.

Test Case 4: 22 cards are facing up and 88 cards are facing down. Therefore we can flip the 22 cards 
