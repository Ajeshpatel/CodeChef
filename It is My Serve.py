...
every player makes 22 consecutive serves before the service changes. Alice makes the
first serve of the match. Therefore the first 2 serves will be made by Alice, then the next 
...
Explanation:
    ...
    Test Case 1: Since no points have been scored yet, this is the first serve of the match. 
    Alice makes the 1st1st serve of the match.
    Test Case 2: Two points have been scored yet. Thus, it is the third serve of the match. 
    Bob makes the 3rd3rd serve of the match.
    Test Case 3: Four points have been scored yet. Thus, it is the fifth serve of the match.
    Alice makes the 5th5th serve of the match.
    Test Case 4: Eleven points have been scored yet. Thus, it is the twelfth serve of the match.
    Bob makes the 12th12th serve of the match.
"""
