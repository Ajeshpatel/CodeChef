...
Output Format:
For each test case, print on a new line YES if Chef will be able to enter the fair with all his N friends
and NO otherwise.
...
Test case 1: Chef needs 5 passes for his friends and one pass for himself and he collected 8 passes. 
Thus he will be able to enter the fair with all his friends.

Test case 2: Chef needs 6 passes for his friends and one pass for himself while he collected only 3 passes.
Thus he will not be able to enter the fair with all his friends, only three of them can enter the fair.

Test case 3: Chef needs 2 passes for his friends and one pass for himself while he collected only 2 passes. 
Thus either Chef or one of his friends can't enter the fair.

Test case 4: Chef needs a total of 2 passes, one for himself and one for his friend. He collected 2 passes.
