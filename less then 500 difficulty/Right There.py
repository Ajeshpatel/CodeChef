...
Input Format:
    ...
    Each test case consists of two space-separated integers N and X — the total number of people 
    and the capacity of the party hall.
...
Test case 2: Chef wants to host a party with 4 people. Since the capacity of the hall is 3, he can not
host the party.

Test case 3: Chef wants to host a party with 6 people. Since the capacity of the hall is 6, he can host the party.

Test case 4: Chef wants to host a party with 10 people. Since the capacity of the hall is 9, he can not 
host the party.
